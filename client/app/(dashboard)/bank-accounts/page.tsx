                      ...
                      {account.reconciliation_status && (
                        <div className="mb-4 rounded-lg bg-white/5 p-3 space-y-2">
                          <div className="flex items-center justify-between">
                            ...
                            >
                              {account.reconciliation_status
                                .charAt(0)
                                .toUpperCase() +
                                account.reconciliation_status.slice(1)}
                            </span>
                          </div>
                          ...
                          {account.statement_balance !== null &&
                            account.statement_balance !== undefined && (
                              <div className="flex items-center justify-between text-xs">
                                <span className="text-slate-400">
                                  Statement Balance
                                </span>
                          ...
                          {account.balance_discrepancy_amount !== null &&
                            account.balance_discrepancy_amount !== undefined &&
                            account.balance_discrepancy_amount !== 0 && (
                              <div className="flex items-center justify-between text-xs pt-2 border-t border-white/5">
                                ...
                                <span className="text-orange-400 font-medium">
                                  ₹
                                  {Math.abs(
                                    account.balance_discrepancy_amount,
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="mx-4 w-full max-w-md rounded-2xl border border-white/10 bg-[#0f172a] p-6">
            ...
            <p className="mt-2 text-sm text-slate-400">
              Are you sure you want to delete this bank account? This won&apos;t
