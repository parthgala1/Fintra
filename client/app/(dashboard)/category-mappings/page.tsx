...
import {
  api,
  CategoryMapping,
  CreateCategoryMappingData,
  UpdateCategoryMappingData,
  TestCategoryMappingData,
} from "@/lib/api";
            ...
            {testResult && (
              <div className="mt-4 flex items-center gap-2 rounded-xl bg-green-500/10 border border-green-500/20 p-3">
                ...
                <span className="text-sm text-green-400">
                  Matches:{" "}
                  <strong>&quot;{testResult.matched_keyword}&quot;</strong> →{" "}
                  <strong>{testResult.category_name}</strong>
                </span>
              </div>
            )}
          </div>
          ...
          <div className="mx-4 w-full max-w-md rounded-2xl border border-white/10 bg-[#0f172a] p-6">
            ...
            <div className="mt-6 flex items-center justify-end gap-3">
              ...
              <button
                ...
                disabled={
                  isSaving || !formData.keyword.trim() || !formData.category_id
                }
